...
class SegModel(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = {
            ...
            'monitor': 'val_loss',  # Adjust based on the monitored metric
            'interval': 'epoch',    # Adjust based on when you want to adjust the learning rate
            'frequency': 1          # Adjust based on how often you want to adjust the learning rate
        }
